...
Formula:
  ...
  s3 = sim(image <-> audio)   via ImageBind  (direct â€” no text bridge)
...
# â”€â”€ lambda values to test â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ load ImageBind â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _load_audio_tensor(audio_path):
    """Load .wav â†’ mel spectrogram tensor expected by ImageBind's audio encoder.
...
# â”€â”€ score one prompt â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def main():
    print("=" * 70)
    print("  MULTIMEDIA COHERENCE SCORE â€” ImageBind â€” All Prompts")
    ...
    print("\n" + "=" * 70)
    print("  SUMMARY â€” Average scores across all prompts")
    print("=" * 70)
    print(f"  {'Metric':<20} {'Average'}")
    print(f"  {'-'*35}")
    print(f"  {'s1 (textâ†”image)':<20} {df['s1_text_image'].mean():.4f}")
    print(f"  {'s2 (textâ†”audio)':<20} {df['s2_text_audio'].mean():.4f}")
    print(f"  {'s3 (imageâ†”audio)':<20} {df['s3_image_audio'].mean():.4f}")
