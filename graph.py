...
class GraphGenerator:
    ...
    def generate_all_graphs(self):
        ...
        # Load scores
        text_scores = self.load_scores_from_csv(self.scores_dir / "text_scores.csv")
        image_scores = self.load_scores_from_csv(self.scores_dir / "image_scores.csv")
        audio_scores = self.load_scores_from_csv(self.scores_dir / "audio_scores.csv")
